        ...
        return (
            ...
            <LinearGradient style={styles.container}
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 180 }}>
                    ...
                    <Text style={{ textAlign: 'center', color: '#000000', fontWeight: 'bold', fontSize: 16, top: 20 }}>Successfully Registered!</Text>
                    <TouchableOpacity
                    ...
                    >
                        <Text style={{ textAlign: 'center', color: '#ffffff', fontWeight: 'bold', fontSize: 16 }}>Ok</Text>
                    </TouchableOpacity>
